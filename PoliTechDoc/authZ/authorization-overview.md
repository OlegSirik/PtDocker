...
«Кто пользователь?»
Авторизация (Authorization) — отвечает на вопрос
«Что и в каком контексте ему разрешено?»
...
меняются редко и контролируются версионированием
упрощают анализ безопасности
исключают «магические» права в данных

При необходимости модель может быть расширена до:
...
| Ресурс      | Разрешение  | Описание                      | SYS   | TNT   | GROUP | PRODUCT | ACCOUNT | SUB |
