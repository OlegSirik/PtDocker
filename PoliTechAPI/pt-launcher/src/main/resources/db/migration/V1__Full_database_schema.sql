...
CREATE SEQUENCE IF NOT EXISTS acc_tenants_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS acc_clients_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS acc_accounts_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS acc_product_roles_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS acc_logins_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS acc_account_logins_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS acc_account_tokens_seq START WITH 1 INCREMENT BY 1;
