...
public final class VariableContextImpl2 implements CalculatorContext
{

    private static final Logger logger = LoggerFactory.getLogger(VariableContextImpl2.class);
    ...
    public VariableContextImpl2(String json, List<PvVarDefinition> vars) {
